...
+ (NSTimeInterval)displayDurationForString:(NSString*)string {
    return MIN((float)string.length * 0.07 + 0.5, [self sharedView].minimumDismissTimeInterval);
}
...
//        return [UIColor blackColor];
       return [UIColor colorWithRed:0.071 green:0.060 blue:0.086 alpha:1.000];
    } else {
